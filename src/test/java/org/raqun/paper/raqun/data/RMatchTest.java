...
public class RMatchTest {
    ...
    public void isValidFindsDuplicateModelsInTuple() {
        ...
        RMatch validTuple = new RMatch(weightMetric, firstElement);
        assert validTuple.getElements().size() == 1;
        assert validTuple.isValid();

        validTuple = new RMatch(weightMetric, firstElement, secondElement);
        assert validTuple.getElements().size() == 2;
        assert validTuple.isValid();

        // Now check that invalid tuples can be found
        RMatch invalidTuple = new RMatch(weightMetric, invalidElement, firstElement, secondElement);
    ...
    public void mergeOneElementTuple() {
        ...
        RMatch firstTuple = new RMatch(weightMetric, firstElement);
        ...
        RMatch secondTuple = new RMatch(weightMetric, secondElement);
    ...
    public void mergeMultiElementTuple() {
        ...
        secondElement.getProperties().add("property2");
        secondElement.getProperties().add("property3");
        RMatch firstTuple = new RMatch(weightMetric, firstElement, secondElement);
        ...
        RMatch secondTuple = new RMatch(weightMetric, thirdElement, fourthElement, fifthElement);
        ...
        RMatch thirdTuple = new RMatch(weightMetric, sixthElement);
